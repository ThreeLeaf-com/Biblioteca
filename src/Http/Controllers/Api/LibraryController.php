 ...
 */
#[OA\Tag(name: 'Biblioteca/Library', description: 'General endpoints for the Biblioteca')]
                ...
                content: new OA\JsonContent(
                    ...
                    properties: [
                        new OA\Property(
                            property: 'series_ids',
                            type: 'array',
                            items: new OA\Items(type: 'string', example: 'b1234567-89ab-cdef-0123-456789abcdef'),
                            description: 'Array of series IDs',
                        ),
                        new OA\Property(
                            property: 'book_ids',
                            type: 'array',
                            items: new OA\Items(type: 'string', example: 'a9876543-21ba-fedc-0123-456789abcdef'),
